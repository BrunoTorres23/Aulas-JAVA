...
//		double y = 200.3;
//		int a = 0;
//		double b = 0;		//aqui estão as variaveis declaradas//diferença entre short e int é que short aceitam numeros de ate 16 bits
					//o int tem espaço maior para essas informações de 32
//		short z = (short) 10000;
...
//		int idadePessoa = 61;
//		
//		if (idadePessoa < 18) {   //if: quando tiver mais de uma condição
